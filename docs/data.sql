...
(
    ...
    #         주소 RECEIVER   VARCHAR(20)  NOT NULL,
    #         받는 사람
    PHONE      VARCHAR(13)  NOT NULL,
    #         전화번호 REQUEST    VARCHAR(255),
    #         요청사항 DEFAULT_YN CHAR(1)      NOT NULL DEFAULT 'N',
    #         기본 배송지 여부
...
(
    ...
    #          상품 가격
                            PRODUCT_REGISTRATION_DATE DATETIME NOT NULL DEFAULT NOW(),
    #          상품 등록 날짜
                            PRODUCT_CHANGED_DATE DATE,
    #          상품 수정 날짜
                            PRODUCT_SALES_STATUS_YN CHAR(1) NOT NULL DEFAULT 'Y',
    #          상품 판매 여부
                            PRODUCT_DISCOUNT_RATE INT NOT NULL DEFAULT 0,
    #          상품 할인율
                            NUMBER_OF_PRODUCT BIGINT NOT NULL  DEFAULT 0,
    #          상품 수량
...
(
    ...
    #         복합키 FOREIGN KEY (MEMBER_ID) REFERENCES TBL_MEMBER (MEMBER_ID),
