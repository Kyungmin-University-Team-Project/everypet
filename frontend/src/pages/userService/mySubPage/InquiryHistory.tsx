...
const inquiries = [
    ...
    {id: '123457', title: '상품 문의', date: '2024-07-10', status: '처리 중', answer: '상품 문의에 대한 답변은 현재 검토 중입니다.'},
    {id: '123458', title: '결제 문의', date: '2024-07-05', status: '답변 완료', answer: '결제는 정상적으로 처리되었습니다.'},
    {id: '123459', title: '반품 문의', date: '2024-07-01', status: '처리 중', answer: '반품 요청이 접수되었으며 처리 중입니다.'},
];
                        ...
                        <div className={styles.cardHeader}>
                            ...
                            <span
                                className={classNames(styles.status, {
                                    ...
                                    [styles.inProgress]: inquiry.status === '처리 중',
                                })}
                            >
                                {inquiry.status}
                            </span>
