...
import com.everypet.auth.oauth2.data.dao.OAuth2MemberMapper;
import com.everypet.auth.oauth2.data.dao.OAuth2RoleMapper;
import com.everypet.auth.oauth2.data.domain.OAuth2Member;
import com.everypet.auth.oauth2.data.domain.OAuth2Role;
import com.everypet.auth.oauth2.data.dto.CustomOAuth2User;
import com.everypet.auth.oauth2.data.dto.response.GoogleResponse;
import com.everypet.auth.oauth2.data.dto.response.NaverResponse;
import com.everypet.auth.oauth2.data.dto.response.OAuth2Response;
